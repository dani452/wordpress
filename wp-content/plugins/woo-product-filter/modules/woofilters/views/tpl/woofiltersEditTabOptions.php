<div class="row row-tab" id="row-tab-options">
	...
	<div class="col-xs-12 sub-tab-content" id="sub-tab-options-main" data-no-preview="1">
		...
		<div class="row row-settings-block">
			...
			<div class="settings-block-values settings-w100 col-xs-6 col-sm-7 col-xl-8">
				<div class="settings-value settings-w100">
					<?php 
						HtmlWpf::selectbox('settings[display_on_page]', array(
							'options' => array('shop' => 'Shop', 'category' => 'Product Category', 'tag' => 'Product Tag', 'both' => 'All Woocommerce Pages', 'specific' => 'Specific' . $labelPro),
	...
	<div class="col-xs-12 sub-tab-content" id="sub-tab-options-buttons">
		...
		<div class="row row-settings-block">
			...
			<div class="settings-block-values settings-w100 settings-w100 col-xs-6 col-sm-7 col-xl-8">
